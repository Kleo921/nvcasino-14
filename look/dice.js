...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-a0065c35');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-a0065c35');}
...
function clearFlash(){dieView.classList.remove('rl-win-a0065c35');dieView.classList.remove('rl-lose-a0065c35');if(frameEl){frameEl.classList.remove('rl-win-a0065c35');frameEl.classList.remove('rl-lose-a0065c35');}}
function flashOutcome(won){clearFlash();if(won){dieView.classList.add('rl-win-a0065c35');if(frameEl){frameEl.classList.add('rl-win-a0065c35');}}else{dieView.classList.add('rl-lose-a0065c35');if(frameEl){frameEl.classList.add('rl-lose-a0065c35');}}
...
var brandEl=document.querySelector('.rl-brand-a0065c35');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
